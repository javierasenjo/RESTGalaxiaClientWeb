...
public class ListaPlanetas implements Serializable {
    ...
    public String toString() {
        ...
        for (int i = 0; i < planetas.size(); i++) {
            respuesta += ("<br> Planeta " + planetas.get(i).getIdPlaneta() + ":    Nombre: " + planetas.get(i).getNombre() + "    Edad : " + planetas.get(i).getEdad() + "    Radio: " + planetas.get(i).getRadio());
            //respuesta += ("<br>       Link " + ": " + planetas.get(i).getLinkPlaneta());
        };
        return respuesta;
    }
