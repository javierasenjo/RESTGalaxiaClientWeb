...
public class ObtenerPlaneta extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            //Galaxia galaxia = serviciosGalaxia.getServiciosGalaxiaPort().obtenerGalaxia();
            ...
            out.println("        <form name=\"obtenerPlanetaForm\" method=\"post\" action=\"ObtenerPlanetaMostrar\">\n"
                    + "            Introduce el número del planeta <input type=\"text\" name=\"numPlaneta\"/><br/>\n"
